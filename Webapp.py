...
st.subheader("Rallying together to gather and spread intel on the health of corals using ML")
...
def import_and_predict(image_data, model):
    ...
    text = ("We predict that this is an image of {} coral with a {:.2f}% confidence."
...
st.text("This section's main purpose is for when any receiving organizations have questions\non your submission and need to contact you")
